        ...
        <div class="col"> 
          <div class="card" style="width: 18rem;">
              ...
              <div class="card-body">
                ...
                <a href="/fisika1" class="btn btn-primary">Go somewhere</a>
              </div>
            </div>
          </div>
        ...
        <div class="col"> 
          <div class="card" style="width: 18rem;">
              ...
              <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi consequuntur laborum fugit ducimus ut suscipit nobis et unde deserunt eligendi?</p>
                <a href="/kimia1" class="btn btn-primary">Go somewhere</a>
              </div>
            </div>
          </div>
        ...
        <div class="col"> 
          <div class="card" style="width: 18rem;">
              ...
              <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi consequuntur laborum fugit ducimus ut suscipit nobis et unde deserunt eligendi?</p>
                <a href="/biologi1" class="btn btn-primary">Go somewhere</a>
              </div>
            </div>
          </div>
...
</html><?php /**PATH C:\xampp\htdocs\maprojek\resources\views///artikel_Mipa/main_mipa.blade.php ENDPATH**/ ?>